...
if __name__ == '__main__':
    ...
    parser.add_argument('--destination_file', type=str,                            default='/data/datasets/islandConservationCT/annotations_merged.json',
                        help='Directory to save the pruned annotation file to')
    parser.add_argument('--mapping_file', type=str,                         default='projects/island_conservation_CT/category_map.json',
